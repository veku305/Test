...
<!-- ***********************************************************************************
  ...
  ************************************************************************************** -->
  ...
  <head>  
    ...
    <title> Hernandez RenanCSS Menu Program 5</title>
<html>
      ...
      <table style="width: 100%; margin: auto;">
         ...
         <tr>
            ...
            <td style="width: 70%; color: #000064; font-size: 24px;"  align="center">
               <font face="Trebuchet MS">The restaurant Company</font>
            </td>
...
<li> <a href="http://ocelot.aul.fiu.edu/~rhern268/Includes/Resturant.php"> program 1 </a>
		...
		<li><a href="http://ocelot.aul.fiu.edu/~rhern268">Home</a></li>
		  ...
		  <li><a href="http://ocelot.aul.fiu.edu/~rhern268/Includes/Program4.php">Program 4</a></li>
		  <li><a href="http://ocelot.aul.fiu.edu/~rhern268/Includes/Program5.php">Program 5</a></li>
          <li><a href="http://ocelot.aul.fiu.edu/~rhern268">Home</a></li>
       </ul>
...
<div align="center" style="font-size: 18px;"><b></b></div>
         ...
         <table style="width: 50%; margin: 0px auto; padding-right: 10%;">
            ...
            <td style="width: 40%; text-align: left;">
              ...
              <table>
                ...
                <tr>
                  ...
                  <!-- Column inside table -->
                  <td align="left" width="5%"> <input type="radio" <?php if ($Category == "Latin")   echo "checked"; ?> name="Category" value="Latin"> Latin&nbsp;&nbsp;&nbsp; &nbsp;</td>

                  <!-- Column inside table -->
                  <td align="left" width="5%"> <input type="radio" <?php if ($Category == "Asia") echo "checked"; ?> name="Category" value="Asia"> Asia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

                  <!-- Column inside table -->
                  <td align="left" width="5%"> <input type="radio" <?php if ($Category == "Fastfood") echo "checked"; ?> name="Category" value="Fastfood"> Fastfood&nbsp;</td>
            ...
            <tr>
              ...
              <table>
                ...
                <tr>
                  ...
                  <!-- Column inside table -->
                  <td align="left" width="5.4%"> <input type="checkbox" name="Cuban" 
                    <?php if ($Cuban == "Cuban") echo checked;?>  value="Cuban" >Cuban&nbsp;&nbsp;</td>

                  <!-- Column inside table -->
                  <td align="left" width="5.5%"> <input type="checkbox" name="Japanese" 
                    <?php if ($Japanese == "Japanese") echo checked;?>  value="Japanese" >Japanese</td>

                  <!-- Column inside table -->
                  <td align="left" width="5%"> <input type="checkbox" name="Mcdonalds" 
                    <?php if ($Mcdonalds == "Mcdonalds") echo checked;?>  value="Mcdonalds" >Mcdonalds</td>
            ...
            <tr>
               <td style="width: 5%; text-align: left;">Resturant Name food/type &nbsp; </td>
               <td style="width: 20%;">
                    <div> 
                      <textarea name="SpecialNeeds" rows="5" cols="42"><?php echo $SpecialNeeds;?></textarea>
  	...
  	<tr><td> &nbsp; </td> </tr>  
            ...
            <tr>
               ...
               <td style="width: 20%;" align=center> 
				  ...
				  <input type="submit" name="Contacts"  value="Contact Us">
